...
func TestCreateTask_DefaultsAndProgress(t *testing.T) {
	...
	task, err := env.taskSvc.createTask(ctx, proj.ID, nil, "My Task", "some description", nil, nil, nil, owner.ID)
	if err != nil {
...
func TestMarkDone_BlockedWithoutReferences(t *testing.T) {
	...
	task, err := env.taskSvc.createTask(ctx, proj.ID, nil, "Needs Reference", "", nil, nil, nil, owner.ID)
	if err != nil {
		t.Fatalf("createTask: %v", err)
	}
...
func TestMarkDone_SucceedsWithReference(t *testing.T) {
	...
	task, err := env.taskSvc.createTask(ctx, proj.ID, nil, "Will Finish", "", nil, nil, nil, owner.ID)
	if err != nil {
		t.Fatalf("createTask: %v", err)
	}
...
func TestCancelTask_RequiresReason(t *testing.T) {
	...
	task, err := env.taskSvc.createTask(ctx, proj.ID, nil, "Cancelable", "", nil, nil, nil, owner.ID)
	if err != nil {
		t.Fatalf("createTask: %v", err)
	}
...
func TestDelayTask_RequiresLaterDateAndReason(t *testing.T) {
	...
	task, err := env.taskSvc.createTask(ctx, proj.ID, nil, "Delayable", "", nil, nil, nil, owner.ID)
	if err != nil {
		t.Fatalf("createTask: %v", err)
	}
...
func TestReopenTask_RequiresComment(t *testing.T) {
	...
	task, err := env.taskSvc.createTask(ctx, proj.ID, nil, "Reopenable", "", nil, nil, nil, owner.ID)
	if err != nil {
		t.Fatalf("createTask: %v", err)
	}
...
func TestProgressHistory_TakeThenCancel(t *testing.T) {
	...
	task, err := env.taskSvc.createTask(ctx, proj.ID, nil, "History Task", "", nil, nil, nil, owner.ID)
	if err != nil {
		t.Fatalf("createTask: %v", err)
	}
...
func TestCalendarSync_TakeUpsertsAndDoneClears(t *testing.T) {
	...
	task, err := env.taskSvc.createTask(ctx, proj.ID, nil, "Calendar Task", "", nil, nil, nil, owner.ID)
	if err != nil {
		t.Fatalf("createTask: %v", err)
	}
...
func TestDeleteTask_RemovesCalendarAndCascades(t *testing.T) {
	...
	task, err := env.taskSvc.createTask(ctx, proj.ID, nil, "Deletable Task", "", nil, nil, nil, owner.ID)
	if err != nil {
		t.Fatalf("createTask: %v", err)
	}
...
func TestAddReference_UserAndProjectTypesWithLabel(t *testing.T) {
	...
	task, err := env.taskSvc.createTask(ctx, proj.ID, nil, "Ref Label Task", "", nil, nil, nil, owner.ID)
	if err != nil {
		t.Fatalf("createTask: %v", err)
	}
...
func TestAddReference_UserFiresMention(t *testing.T) {
	...
	task, err := env.taskSvc.createTask(ctx, proj.ID, nil, "Mention Task", "", nil, nil, nil, owner.ID)
	if err != nil {
		t.Fatalf("createTask: %v", err)
	}
...
func TestMarkDone_PersonRefDoesNotSatisfyGate(t *testing.T) {
	...
	task, err := env.taskSvc.createTask(ctx, proj.ID, nil, "Gate Task", "", nil, nil, nil, owner.ID)
	if err != nil {
		t.Fatalf("createTask: %v", err)
	}
